...
async def send_email(recipient: str, subject: str, body: str):
    ...
    message["From"] = "<YOUR_EMAIL>"  # Your Gmail address
    ...
    await send(
        ...
        port=587,
        username="<YOUR_EMAIL>",  # Your Gmail address
        password="<YOUR_APP_PASSWORD>",  # Use an App Password if 2FA is enabled, https://myaccount.google.com/u/1/apppasswords under 2FA auth of Gaccount that you are trying to send email from
        start_tls=True,
    )
